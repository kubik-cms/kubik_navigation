...
Controller.outlets = [];
Controller.values = {};
class navigation_selector_controller_default extends Controller {
  connect() {
    this._renderResults();
  }
  _renderResults() {
...
navigation_selector_controller_default.values = {
  itemType: String
};
navigation_selector_controller_default.targets = [
...
class drag_controller_default extends Controller {
  connect() {
...
resource_setup_controller_default.values = {
  resourceType: String,
  itemAction: String,
  params: Object,
...
resource_setup_controller_default.targets = [
  "scopeSelection",
...
class item_setup_controller_default extends Controller {
  titleValueChanged() {
...
item_setup_controller_default.values = {
  title: String,
  newRecord: Boolean
};
item_setup_controller_default.targets = [
  "title",
  "text",
  "slug"
];
export { drag_controller_default as DragController, item_setup_controller_default as ItemSetupController, navigation_selector_controller_default as NavigationSelectorController, resource_setup_controller_default as ResourceSetupController };
